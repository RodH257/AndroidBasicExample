...
public class RemindersDbAdapter {
	...
	//name of the table to hold the tasks 
    private static final String DATABASE_TABLE = "reminders";
    //the version of the database, if you update the scheme
    // you need to increment this and include an onUpgrade method implementation 
    ...
    //SQLiteOpen-Helper class implemetnation which does creation of the database
    private DatabaseHelper mDbHelper;
    
    //class level instance of the sqlite database object 
    ...
    /**
     * Our implementation of SQLiteOpenHelper
     *
     */
    private static class DatabaseHelper extends SQLiteOpenHelper {

        DatabaseHelper(Context context) {
        	//creates/opens database but does it lazily, so not right now. 
        ...
        public void onCreate(SQLiteDatabase db) {
        	//executes the SQL constructed earlier
    ...
    public RemindersDbAdapter open() throws SQLException {
    	//sets up the database helper
        mDbHelper = new DatabaseHelper(mCtx);
        //opens/creates database
        mDb = mDbHelper.getWritableDatabase();
        
        //returns itself, to access data from it via chaining. 
        return this;
    }
